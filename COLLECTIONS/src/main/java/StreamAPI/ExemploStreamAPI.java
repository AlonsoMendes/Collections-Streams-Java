...
public class ExemploStreamAPI {
    public static void main(String[] args) {
        ...
        // Retorna true se algum elemento possue a letra A minúscula no nome
        System.out.println("Tem algum elemento com letra minúscula no nome: "+ estudantes.stream().anyMatch((elemento) -> elemento.contains("a")));
